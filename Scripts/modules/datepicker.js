            ...
            if (!sf.base.isNullOrUndefined(this.inputElement.getAttribute(prop))) {
                switch (prop) {
                    case 'disabled':
                        ...
                        if (((sf.base.isNullOrUndefined(this.datepickerOptions) || (this.datepickerOptions['enabled'] === undefined)) || dynamic) &&
                            !this.isBlazorServer) {
                    ...
                    case 'readonly':
                        // eslint-disable-next-line @typescript-eslint/dot-notation
                        if (((sf.base.isNullOrUndefined(this.datepickerOptions) || (this.datepickerOptions['readonly'] === undefined)) || dynamic) &&
                            !this.isBlazorServer) {
                    ...
                    case 'placeholder':
                        // eslint-disable-next-line @typescript-eslint/dot-notation
                        if (((sf.base.isNullOrUndefined(this.datepickerOptions) || (this.datepickerOptions['placeholder'] === undefined)) || dynamic) &&
                            !this.isBlazorServer) {
                    ...
                    case 'value':
                        // eslint-disable-next-line @typescript-eslint/dot-notation
                        if (((sf.base.isNullOrUndefined(this.datepickerOptions) || (this.datepickerOptions['value'] === undefined)) || dynamic) &&
                            !this.isBlazorServer) {
