...
var SfToast = /** @class */ (function () {
    ...
    SfToast.prototype.show = function (options) {
        ...
        this.progressObj[id] = { hideEstimatedTimeOfArrival: null, intervalId: null, maxHideTime: null, element: null, timeOutId: null, progressEle: null };
...
var Toast = {
    ...
    hideAnimationToast: function (element, index) {
        if (!sf.base.isNullOrUndefined(element)) {
            element.blazor__instance.hideAnimationToast(element.querySelector('#toast_' + index), index);
        }
    },
    hide: function (element, toastElement, toastObj, interactionType) {
        if (!sf.base.isNullOrUndefined(element)) {
