...
var Clipboard = /** @class */ (function () {
    ...
    Clipboard.prototype.parentContentData = function (selectedIndex, rows, withHeader, index) {
        var getCopyData = 'getCopyData';
        var copyContent = 'copyContent';
        var treeColIndex = this.parent.options.allowRowDragAndDrop && sf.base.isNullOrUndefined(this.parent.options.rowDropTargetID) ?
            this.parent.options.treeColumnIndex + 1 : this.parent.options.treeColumnIndex;
...
var RowDD = /** @class */ (function () {
    ...
    RowDD.prototype.ensuredropPosition = function (draggedRows, currentRow) {
        ...
        draggedRows.filter(function (e) {
            ...
            if (childRows.length) {
                var valid = childRows.map(function (r) { return r.getAttribute('data-uid'); }).indexOf(currentRow.getAttribute('data-uid'));
                if (valid === -1) {
...
var TreeGrid = {
    ...
    paste: function (element, data, rowIndex, colIndex) {
