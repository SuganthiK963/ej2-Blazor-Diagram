    ...
    Tab.prototype.setActiveBorder = function () {
        ...
        if (this.isVertical()) {
            ...
            if (this.overflowMode === 'MultiRow') {
                ...
                sf.base.setStyleAttribute(bar_1, { 'top': trg.offsetHeight + trg.offsetTop + 'px', 'height': '' });
            }
            else {
    ...
    Tab.prototype.initializeDrag = function (target) {
        ...
        var dragObj = new sf.base.Draggable(target, {
            ...
            drag: function (e) {
                ...
                if (!sf.base.isNullOrUndefined(e.target.closest('.' + CLS_TAB)) && !e.target.closest('.' + CLS_TAB).isEqualNode(_this.element) &&
