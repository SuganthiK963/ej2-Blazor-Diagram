...
(function (ListBase) {
    ...
    options, level, isSingleLevel, componentInstance) {
        ...
        var fields = (componentInstance &&
            (componentInstance.getModuleName() == "listview" || componentInstance.getModuleName() == "multiselect")) ? curOpt.fields : sf.base.extend({}, ListBase.defaultMappedFields, curOpt.fields);
        var ariaAttributes = sf.base.extend({}, defaultAriaAttributes, curOpt.ariaAttributes);
        var id;
        var checkboxElement = [];
        if (level) {
        ...
        for (var i = 0; i < dataSource.length; i++) {
            ...
            if (isSingleLevel === true) {
                ...
                if (curOpt.showIcon && fieldData.hasOwnProperty(fields.iconCss) &&
                    ...
                    var iconElement = createElement('div', { className: exports.cssClass.icon + ' ' + fieldData[fields.iconCss] });
                    if (anchorElement) {
