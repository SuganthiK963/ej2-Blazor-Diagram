...
var DropDownBase = /** @class */ (function (_super) {
        ...
        if (type === 'string' || type === 'number' || type === 'boolean') {
            ...
            if (ignoreCase) {
                ...
                if (isTextByValue) {
                    ...
                    dataSource.filter(function (item) {
                        var itemValue = sf.base.getValue(fields.value, item);
                        if (!sf.base.isNullOrUndefined(itemValue) && !sf.base.isNullOrUndefined(value) && itemValue.toString() === compareValue_1.toString()) {
    ...
    DropDownBase.prototype.scrollStop = function (e) {
        var target = !sf.base.isNullOrUndefined(e) ? e.target : this.list;
...
var DropDownList = /** @class */ (function (_super) {
    ...
    DropDownList.prototype.bindCommonEvent = function () {
        sf.base.EventHandler.add(this.targetElement(), 'blur', this.onBlurHandler, this);
        var formElement = sf.base.closest(this.inputElement, 'form');
        if (formElement) {
    ...
    DropDownList.prototype.unBindCommonEvent = function () {
        if (this.targetElement()) {
            sf.base.EventHandler.remove(this.targetElement(), 'blur', this.onBlurHandler);
        }
    ...
    DropDownList.prototype.setValue = function (e) {
        ...
        else if (!sf.base.isNullOrUndefined(this.valueTempElement) && this.inputElement.previousSibling === this.valueTempElement) {
            sf.base.detach(this.valueTempElement);
            this.inputElement.style.display = 'block';
        }
    ...
    DropDownList.prototype.setSearchBox = function (popupElement) {
        if (this.isFiltering()) {
            ...
            sf.base.EventHandler.add(this.filterInput, 'blur', this.onBlurHandler, this);
    ...
    DropDownList.prototype.updateActionCompleteDataValues = function (ulElement, list) {
        ...
        if (sf.base.isNullOrUndefined(this.actionData.ulElement) && sf.base.isNullOrUndefined(this.actionData.list)) {
    ...
    DropDownList.prototype.closePopup = function (delay) {
        ...
        if (this.isFilterLayout()) {
            ...
            sf.base.EventHandler.remove(this.filterInput, 'blur', this.onBlurHandler);
    ...
    DropDownList.prototype.checkData = function (newProp) {
        ...
        else if (this.allowFiltering && newProp.query && !sf.base.isNullOrUndefined(Object.keys(newProp.query))) {
            this.actionData = this.actionCompleteData;
        }
    };
    ...
    DropDownList.prototype.showPopup = function () {
        ...
        if (this.isFiltering() && this.dataSource instanceof sf.data.DataManager && (this.actionData.list != this.actionCompleteData.list) &&
    ...
    DropDownList.prototype.hidePopup = function (e) {
        ...
        this.closePopup();
        var dataItem = this.getItemData();
        var isSelectVal = !sf.base.isNullOrUndefined(this.selectedLI);
...
var DropDownTree = /** @class */ (function (_super) {
    ...
    DropDownTree.prototype.render = function () {
        var isTree = sf.base.select('#' + this.element.id + '_tree', document);
        if (isTree) {
            var popupDiv = sf.base.select('#' + this.element.id + '_popup', document);
            sf.base.detach(popupDiv ? popupDiv : isTree.parentElement);
        }
        ...
        this.wireTreeEvents();
        sf.base.addClass([this.popupDiv], DDTHIDEICON);
        this.renderTree();
    ...
    DropDownTree.prototype.renderPopup = function () {
        ...
        this.trigger('beforeOpen', args, function (args) {
            ...
            if (_this.isFirstRender && !isCancelled) {
                ...
                sf.base.removeClass([_this.popupDiv], DDTHIDEICON);
            ...
            if (!isCancelled) {
                ...
                sf.base.removeClass([_this.popupEle], DDTHIDEICON);
    ...
    DropDownTree.prototype.getNodeData = function (id) {
        ...
        if (sf.base.isNullOrUndefined(id)) {
            ...
            for (var i = 0, objlen = this.treeItems.length; i < objlen; i++) {
                var dataId = sf.base.getValue(this.fields.value, this.treeItems[i]);
                if (!sf.base.isNullOrUndefined(this.treeItems[i]) && !sf.base.isNullOrUndefined(dataId) && dataId.toString() === id) {
    ...
    DropDownTree.prototype.getChildNodeData = function (obj, mapper, id) {
        ...
        for (var i = 0, objlen = obj.length; i < objlen; i++) {
            var dataValue = sf.base.getValue(mapper.value, obj[i]);
            if (obj[i] && dataValue && dataValue.toString() === id) {
                ...
                var childNodeData = sf.base.getValue(mapper.child, obj[i]);
                ...
                var child = 'child';
                newChildItems = this.getChildNodeData(sf.base.getValue(child, obj[i]), this.getChildMapperFields(mapper), id);
                if (newChildItems !== undefined) {
                    break;
                }
            }
    ...
    DropDownTree.prototype.setTagValues = function () {
        ...
        if (tempArr) {
            ...
            sf.base.append(tempArr, chipContent);
        }
        chip.appendChild(chipContent);
        this.chipCollection.appendChild(chip);
    };
    ...
    __decorate$2([
        sf.base.Property("${value.length} item(s) selected")
...
var ComboBox = /** @class */ (function (_super) {
    ...
    ComboBox.prototype.wireEvent = function () {
        if (this.getModuleName() === 'combobox') {
            ...
            sf.base.EventHandler.add(this.inputWrapper.container, 'blur', this.onBlurHandler, this);
        }
    ...
    ComboBox.prototype.clearAll = function (e, property) {
        ...
        if (this.isFiltering() && !sf.base.isNullOrUndefined(e) && e.target === this.inputWrapper.clearButton) {
            this.searchLists(e);
        }
    };
    ...
    ComboBox.prototype.unWireEvent = function () {
        if (this.getModuleName() === 'combobox') {
            ...
            sf.base.EventHandler.remove(this.inputWrapper.container, 'blur', this.onBlurHandler);
        }
        if (!sf.base.isNullOrUndefined(this.inputWrapper.buttons[0])) {
        ...
        for (var _i = 0, _a = Object.keys(newProp); _i < _a.length; _i++) {
            ...
            switch (prop) {
                ...
                default: {
                    ...
                    if (this.isFiltering() && prop === 'dataSource' && sf.base.isNullOrUndefined(this.list) && this.itemTemplate &&
                        this.getModuleName() === 'combobox') {
                        _super.prototype.renderList.call(this);
                    }
                    break;
...
function createFloatLabel(overAllWrapper, searchWrapper, element, inputElement, value, floatLabelType, placeholder) {
    var floatLinelement = sf.base.createElement('span', { className: FLOATLINE });
    var floatLabelElement = sf.base.createElement('label', { className: FLOATTEXT });
...
var MultiSelect = /** @class */ (function (_super) {
    ...
    MultiSelect.prototype.removelastSelection = function (e) {
        ...
        if (this.allowCustomValue && (value !== 'false' && customValue === false || (!sf.base.isNullOrUndefined(customValue) &&
    ...
    MultiSelect.prototype.updateActionList = function (ulElement, list, e, isUpdated) {
        ...
        if (this.value && this.value.length && ((this.mode !== 'CheckBox' && this.inputElement.value.trim() !== '') ||
            ...
            this.allowCustomValue && this.dataSource instanceof sf.data.DataManager && this.inputElement.value === ''))) {
            this.refreshSelection();
        }
        this.updateListARIA();
        this.unwireListEvents();
    ...
    MultiSelect.prototype.getValidLi = function () {
        ...
        return (!sf.base.isNullOrUndefined(liElement) ? liElement : this.liCollections[0]);
    };
    ...
    MultiSelect.prototype.checkForCustomValue = function (query, fields) {
        ...
        if (this.allowCustomValue && dataChecks) {
            ...
            if (typeof (customData) !== 'string' && typeof (customData) !== 'number' && typeof (customData) !== 'boolean') {
                ...
                if (typeof sf.base.getValue((this.fields.value ? this.fields.value : 'value'), customData)
                    === 'number') {
    ...
    MultiSelect.prototype.removeAllItems = function (value, eve, isClearAll, element, mainElement) {
        ...
        var className = this.hideSelectedItem ?
            HIDE_LIST :
            dropDownBaseClasses.selected;
        sf.base.removeClass([element], className);
    ...
    MultiSelect.prototype.wireEvent = function () {
        ...
        sf.base.EventHandler.add(this.inputElement, 'blur', this.onBlurHandler, this);
    ...
    MultiSelect.prototype.unWireEvent = function () {
        ...
        sf.base.EventHandler.remove(this.inputElement, 'blur', this.onBlurHandler);
    ...
    MultiSelect.prototype.textboxValueUpdate = function (event) {
        var isRemoveAll = event && event.target && (sf.base.closest(event.target, '.e-selectall-parent')
            ...
            this.trigger('close', eventArgs, function (eventArgs) {
                if (!eventArgs.cancel) {
                    if (_this.fields.groupBy && _this.mode !== 'CheckBox' && _this.fixedHeaderElement) {
                        sf.base.remove(_this.fixedHeaderElement);
                        _this.fixedHeaderElement = null;
                    }
                    _this.beforePopupOpen = false;
    ...
    CheckBoxSelection.prototype.onDocumentClick = function (e) {
        if (this.parent.getLocaleName() !== 'listbox') {
            ...
            if (!(!sf.base.isNullOrUndefined(this.parent.popupObj) && sf.base.closest(target, '[id="' + this.parent.popupObj.element.id + '"]')) &&
                ...
                this.parent.scrollFocusStatus = (sf.base.Browser.isIE || sf.base.Browser.info.name === 'edge') &&
                    (document.activeElement === this.filterInput);
            }
...
var ListBox = /** @class */ (function (_super) {
    ...
    ListBox.prototype.setCssClass = function () {
        ...
        if (this.enableRtl) {
            sf.base.addClass([this.list], 'e-rtl');
        }
    };
    ...
    ListBox.prototype.onActionComplete = function (ulElement, list, e) {
        ...
        if (this.toolbarSettings.items.length && this.scope && this.scope.indexOf('#') > -1 && !sf.base.isNullOrUndefined(e)) {
            var scope = this.scope.replace('#', '');
            var scopedLB = sf.base.getComponent(document.getElementById(scope), this.getModuleName());
    ...
    ListBox.prototype.dragEnd = function (args) {
        ...
        var dragArgs = sf.base.extend({}, getArgs, { target: args.target, source: { previousData: this.dataSource }, previousIndex: args.previousIndex, currentIndex: args.currentIndex });
        if (listObj !== this) {
        ...
        if (listObj === this) {
            ...
            if (listObj.sortOrder !== 'None' || this.selectionSettings.showCheckbox
                ...
                var sortable = sf.base.getComponent(ul_2, 'sortable');
    ...
    ListBox.prototype.setFiltering = function () {
        var filterInputObj;
        if (this.initLoad || sf.base.isNullOrUndefined(this.filterParent)) {
    ...
    ListBox.prototype.moveAllData = function (fListBox, tListBox, isKey, index) {
        ...
        sf.lists.moveTo(fListBox.ulElement, tListBox.ulElement, 
    ...
    ListBox.prototype.checkDisabledState = function (inst) {
        return inst.ulElement.querySelectorAll('.' + sf.lists.cssClass.li).length === 0;
    };
