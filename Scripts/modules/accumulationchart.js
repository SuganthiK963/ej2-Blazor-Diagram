...
var AccumulationSeries = /** @class */ (function (_super) {
    ...
    AccumulationSeries.prototype.setPoints = function (data, i, colors, accumulation) {
        ...
        point.legendImageUrl = sf.base.getValue(this.legendImageUrl, data[i]);
...
var LegendSettings = /** @class */ (function (_super) {
    ...
    __decorate$5([
        sf.base.Complex({ left: 0, right: 0, top: 0, bottom: 0 }, ContainerPadding)
...
var BaseLegend = /** @class */ (function () {
    ...
    BaseLegend.prototype.renderSymbol = function (legendOption, group, i) {
        ...
        var textSize = sf.svgbase.measureText(legendOption.text, this.legend.textStyle);
        ...
        if (!isCanvas) {
            group.appendChild(drawSymbol({ x: x, y: y }, shape, new sf.svgbase.Size(this.legend.shapeWidth, this.legend.shapeHeight), legendOption.url, symbolOption, this.accessbilityText, this.chart.renderer, null, this.isBulletChartControl, control));
        }
        else {
            regionPadding = -this.translatePage(null, this.currentPageNumber - 1, this.currentPageNumber);
            drawSymbol({ x: x, y: y }, shape, new sf.svgbase.Size(this.legend.shapeWidth, this.legend.shapeHeight), '', symbolOption, this.accessbilityText, this.chart.renderer, this.currentPageNumber ? new sf.svgbase.Rect(0, regionPadding, 0, 0) : null, this.isBulletChartControl, control);
        ...
        if (shape === 'Line' && legendOption.markerVisibility && legendOption.markerShape !== 'Image' ||
            ...
            if (!isCanvas) {
                // eslint-disable-next-line max-len
                group.appendChild(drawSymbol({ x: x, y: y }, shape, new sf.svgbase.Size(this.legend.shapeWidth / 2, this.legend.shapeHeight / 2), '', symbolOption, this.accessbilityText, null, null, this.isBulletChartControl, control));
            }
            else {
                drawSymbol({ x: x, y: y }, shape, new sf.svgbase.Size(this.legend.shapeWidth / 2, this.legend.shapeHeight / 2), '', symbolOption, this.accessbilityText, this.chart.renderer, this.currentPageNumber ?
    ...
    BaseLegend.prototype.renderPagingElements = function (chart, bounds, textOption, legendGroup) {
        ...
        if (legend.enablePages || this.isBulletChartControl) {
            pageTextElement = textElement(chart.renderer, textOption, legend.textStyle, color, paginggroup, false, false, false, false, null, new sf.svgbase.Rect(bounds.width - (2 * (iconSize + padding) + padding + size.width), 0, 0, 0));
        }
...
var PieBase = /** @class */ (function (_super) {
    ...
    PieBase.prototype.getSeriesBound = function (series) {
        ...
        series.findMaxBounds(rect, new sf.svgbase.Rect(this.pieBaseCenter.x, this.pieBaseCenter.y, 0, 0));
...
var AccumulationChart = /** @class */ (function (_super) {
    ...
    AccumulationChart.prototype.unWireEvents = function () {
        ...
        window.removeEventListener((sf.base.Browser.isTouch && ('orientation' in window && 'onorientationchange' in window)) ? 'orientationchange' : 'resize', this.accumulationResizeBound);
    };
    /**
    ...
    AccumulationChart.prototype.wireEvents = function () {
        ...
        window.addEventListener((sf.base.Browser.isTouch && ('orientation' in window && 'onorientationchange' in window)) ? 'orientationchange' : 'resize', this.accumulationResizeBound);
    ...
    AccumulationChart.prototype.renderTitle = function () {
        ...
        var rect = new sf.svgbase.Rect(margin.left, 0, this.availableSize.width - margin.left - margin.right, 0);
    ...
    AccumulationChart.prototype.renderSubTitle = function (options) {
        ...
        var rect = new sf.svgbase.Rect(alignment === 'Center' ? (options.x - maxWidth / 2) : alignment === 'Far' ? options.x - maxWidth : options.x, 0, maxWidth, 0);
                ...
                case 'series':
                    if (!this.animateselected) {
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            if (newProp.series[i] && !sf.base.isNullOrUndefined(newProp.series[i].explodeIndex) && newProp.series[i].explodeIndex >= 0
...
var AccumulationLegend = /** @class */ (function (_super) {
    ...
    AccumulationLegend.prototype.click = function (event) {
        ...
        if (this.chart.accumulationSelectionModule) {
            var selectedDataIndexes = sf.base.extend([], this.chart.accumulationSelectionModule.selectedDataIndexes, null, true);
        }
...
var AccumulationDataLabel = /** @class */ (function (_super) {
    ...
    AccumulationDataLabel.prototype.calculateLabelSize = function (isTemplate, childElement, point, points, argsData, datalabelGroup, id, dataLabel, redraw, clientRect, isReactCallback) {
        var textSize = isTemplate ? (isReactCallback ? { width: clientRect.width, height: clientRect.height } : this.getTemplateSize(childElement, point, argsData, redraw, isTemplate, points, datalabelGroup, id, dataLabel)) : sf.svgbase.measureText(point.label, dataLabel.font);
    ...
    BaseTooltip.prototype.createTooltip = function (chart, isFirst, location, clipLocation, point, shapes, offset, bounds, extraPoints, templatePoint, customTemplate) {
        ...
        if (this.text.length <= 1) {
            ...
            if (tooltipTemplate && chart.getModuleName() === 'chart' && tooltipTemplate[0] !== '#' && typeof tooltipTemplate === 'string') {
                ...
                contentSize = new sf.svgbase.Size(templateDiv.firstElementChild.offsetWidth, templateDiv.firstElementChild.offsetHeight);
                headerSize = new sf.svgbase.Size(0, 0);
                templateDiv.remove();
            }
            else {
                contentSize = sf.svgbase.measureText(this.text[0], chart.tooltip.textStyle);
                headerSize = (!(this.header === '' || this.header === '<b></b>')) ? sf.svgbase.measureText(this.header, this.textStyle) :
