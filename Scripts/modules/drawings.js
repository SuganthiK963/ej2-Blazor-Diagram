...
var ShapeStyle = /** @class */ (function (_super) {
    ...
    __decorate([
        sf.base.ComplexFactory(getGradientType)
...
var TextStyle = /** @class */ (function (_super) {
    ...
    __decorate([
        sf.base.Property('CollapseSpace')
    ], TextStyle.prototype, "whiteSpace", void 0);
    __decorate([
        sf.base.Property('WrapWithOverflow')
...
function multiplyPoint(matrix, x, y) {
    switch (matrix.type) {
        case exports.MatrixTypes.Identity: break;
