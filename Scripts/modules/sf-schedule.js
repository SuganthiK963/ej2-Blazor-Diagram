...
var VerticalViews = /** @class */ (function (_super) {
    ...
    VerticalViews.prototype.onScrollUiUpdate = function (args) {
        ...
        var isDateHeaderScroll = this.parent.options.enableAllDayScroll ? !((content.offsetWidth - content.clientWidth) <=
...
var TimelineViews = /** @class */ (function (_super) {
    ...
    TimelineViews.prototype.scrollToWorkHour = function () {
        ...
        if (firstWorkHourCell) {
            this.getContentAreaElement().scrollLeft = !this.parent.options.enableRtl ? firstWorkHourCell.offsetLeft :
...
var MonthAgenda = /** @class */ (function (_super) {
    ...
    MonthAgenda.prototype.setEventWrapperHeight = function () {
        ...
        var availableHeight = this.parent.element.offsetHeight - headerHeight - dateHeader.offsetHeight -
...
var Year = /** @class */ (function (_super) {
    ...
    Year.prototype.updateCellHeight = function (cell, height) {
        if (height > cell.offsetHeight) {
            sf.base.setStyleAttribute(cell.parentElement.querySelector('td'), { 'height': height + 'px' });
            if (this.parent.activeViewOptions.group.resources.length > 0) {
                var resourceCell = this.parent.element.querySelector('.' + RESOURCE_COLUMN_TABLE_CLASS + ' ' + 'tbody td[data-group-index="' +
                    cell.getAttribute('data-group-index') + '"]');
                if (resourceCell) {
...
var WorkCellInteraction = /** @class */ (function () {
    ...
    WorkCellInteraction.prototype.cellDblClick = function (e) {
        if (this.parent.activeViewOptions.readonly || this.isPreventAction(e) ||
            sf.base.closest(e.target, '.' + DISABLE_DATES)) {
            return;
        }
...
var KeyboardInteraction = /** @class */ (function () {
    ...
    KeyboardInteraction.prototype.processTab = function (e, isReverse) {
        ...
        if (target.classList.contains(RESOURCE_CELLS_CLASS) && this.parent.isTimelineView()
        ...
        if (target.classList.contains(APPOINTMENT_CLASS)) {
            ...
            if ((isTimeline || isTimelineYear && this.parent.activeViewOptions.orientation === 'Vertical') && this.parent.activeViewOptions.group.resources.length > 0) {
                ...
                if (resourceCell && (isReverse && target.getAttribute('data-guid') === appointments[0].getAttribute('data-guid') ||
                    !isReverse && target.getAttribute('data-guid') === appointments.slice(-1)[0].getAttribute('data-guid'))) {
                    this.parent.eventBase.removeSelectedAppointmentClass();
                    if (this.parent.virtualScrollModule) {
                    ...
                    if (this.parent.isTimelineView() && this.parent.activeViewOptions.group.resources.length > 0 &&
                        sf.base.isNullOrUndefined(this.parent.virtualScrollModule)) {
                        this.setScrollPosition(index);
                    }
                    e.preventDefault();
                    return;
        ...
        if (target && !target.classList.contains(RESOURCE_CELLS_CLASS) && this.parent.isTimelineView()
            && this.parent.activeViewOptions.group.resources.length > 0) {
...
var ActionBase = /** @class */ (function () {
    ...
    ActionBase.prototype.removeCloneElementClasses = function () {
        ...
        if (this.parent.options.currentView === 'Month' || this.parent.options.currentView === 'TimelineYear' ||
            this.parent.options.currentView === 'Day' || this.parent.options.currentView === 'Week' || this.parent.options.currentView === 'WorkWeek' ||
            (!this.parent.isTimelineView() && !this.parent.activeViewOptions.timeScale.enable)) {
    ...
    ActionBase.prototype.dynamicYearlyEventsRendering = function (event, isResize, cloneElement) {
        ...
        if (ele.style.backgroundColor !== '') {
            sf.base.setStyleAttribute(appointmentElement, { 'backgroundColor': ele.style.backgroundColor });
        }
...
var DragAndDrop = /** @class */ (function (_super) {
    ...
    DragAndDrop.prototype.dragHelper = function (e) {
        ...
        var elements = [];
        if (!this.parent.options.allowMultiDrag || sf.base.isNullOrUndefined(this.parent.selectedElements) ||
        ...
        elements.forEach(function (ele) {
            ...
            if (ele.getAttribute('data-guid') === _this.actionObj.element.getAttribute('data-guid')) {
                ...
                if (!_this.parent.options.eventDragArea && _this.parent.options.currentView !== 'Month' &&
                    ...
                    sf.base.setStyleAttribute(_this.actionObj.clone, { cursor: 'move', left: '0%', right: '0%', width: '100%' });
                }
    ...
    DragAndDrop.prototype.calculateVerticalTime = function (e) {
        ...
        if (this.multiData.length > 0) {
            ...
            if (this.isAllDayTarget && this.isAllDayDrag &&
                !sf.base.isNullOrUndefined(this.actionObj.isAllDay) && this.actionObj.isAllDay && this.swagData.length > 0) {
    ...
    DragAndDrop.prototype.updateMultipleData = function (data, timeDifference) {
        ...
        if (!sf.base.isNullOrUndefined(this.actionObj.isAllDay) && this.parent.activeViewOptions.timeScale.enable &&
    ...
    DragAndDrop.prototype.updateEventHeight = function (event, index, colIndex) {
        ...
        var isFullDay = ((event.endTime.getTime() - event.startTime.getTime())
            / MS_PER_DAY) >= 1;
...
var InlineEdit = /** @class */ (function () {
    ...
    InlineEdit.prototype.createInlineAppointmentElement = function () {
        ...
        if (this.eventWrapColor !== '') {
            sf.base.setStyleAttribute(inlineAppointmentElement, { backgroundColor: this.eventWrapColor });
        }
    ...
    InlineEdit.prototype.eventEdit = function (activeEvent) {
        ...
        if (inlineSubject) {
            ...
            if (sf.base.closest(activeEvent, '.' + MORE_POPUP_WRAPPER_CLASS)) {
                ...
                var elementSelector = ['TimelineDay', 'TimelineWeek', 'TimelineWorkWeek', 'TimelineMonth'].indexOf(this.parent.options.currentView) > -1 ?
...
var SfSchedule = /** @class */ (function () {
    function SfSchedule(element, options, viewOptions, dotnetRef, isPrintSchedule) {
        ...
        this.uiStateValues = {
            expand: false, isInitial: true, left: 0, top: 0, isGroupAdaptive: options.isGroupAdaptive,
    ...
    SfSchedule.prototype.scrollContentReady = function (updateHeight) {
        if (this.virtualScrollModule) {
            if (updateHeight) {
                ...
                var data = { cssProperties: this.getCssProperties(), isPreventScrollUpdate: true };
...
var Schedule = {
    ...
    printWithOptions: function (element, dotnetRef, printOptions) {
        if (element) {
    ...
    createQuickPopup: function (element, guid, isServerBinding, isPrevent) {
        if (element && element.blazor__instance) {
    ...
    // eslint-disable-next-line max-len
    inlineEdit: function (element, clickType, isTemplate, guid, setFocus, resColor) {
        if (guid === void 0) { guid = null; }
        if (element && element.blazor__instance) {
    ...
    getRowIndex: function (element, left, top) {
        if (element && element.blazor__instance) {
            var target = document.elementFromPoint(left, top);
            var targetElement = void 0;
            if (target) {
