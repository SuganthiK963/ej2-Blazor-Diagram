...
namespace Syncfusion.Blazor.DropDowns
{
    ...
    public partial class AutoCompleteEvents<TValue, TItem> : SfBaseComponent
    {
        [CascadingParameter]
        private SfAutoComplete<TValue, TItem> BaseParent { get; set; }
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            BaseParent.AutocompleteEvents = this;
        }
