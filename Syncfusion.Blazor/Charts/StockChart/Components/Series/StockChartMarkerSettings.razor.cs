...
namespace Syncfusion.Blazor.Charts
{
    ...
    /// </summary>
    public partial class StockChartMarkerSettings
    {
        internal StockChartDataLabelSettings DataLabel { get; set; } = new StockChartDataLabelSettings();

        internal StockChartTrendlineMarkerBorder Border { get; set; } = new StockChartTrendlineMarkerBorder();
