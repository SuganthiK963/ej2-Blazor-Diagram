...
namespace Syncfusion.Blazor.Charts
{
    ...
    /// </summary>
    public class RangeNavigatorBorder : ChartCommonBorder
    {
        [CascadingParameter]
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            Parent.UpdateChildProperties("NavigatorBorder", this);
        }
        ...
        protected override async Task OnParametersSetAsync()
        {
            ...
            {
                SfBaseUtils.UpdateDictionary("NavigatorBorder", this, Parent.PropertyChanges);
