...
namespace Syncfusion.Blazor.Charts
{
    ...
    /// </summary>
    public partial class RangeNavigatorMajorGridLines : ChartCommonMajorGridLines
    {
        [CascadingParameter]
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            Parent.UpdateChildProperties("MajorGridLines", this);
        }
        ...
        protected override async Task OnParametersSetAsync()
        {
            ...
            {
                SfBaseUtils.UpdateDictionary("MajorGridLines", this, Parent.PropertyChanges);
