...
namespace Syncfusion.Blazor.CircularGauge
{
    ...
    /// </summary>
    public class CircularGaugeAnnotationTextStyle : CircularGaugeFontSettings
    {
        ...
        /// <summary>
        /// Gets or sets the properties to render annotaions.
        /// </summary>
        [CascadingParameter]
        internal CircularGaugeAnnotation DynamicParent { get; set; }
