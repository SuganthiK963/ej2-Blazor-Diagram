...
namespace Syncfusion.Blazor.CircularGauge
{
    ...
    /// </summary>
    public class CircularGaugeAxisMinorTicks : CircularGaugeTickSettings
    {
        ...
        /// <summary>
        /// Gets or sets the height of the minor ticks.
        /// </summary>
        public override double Height { get; set; } = 5;
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            DynamicParent.UpdateChildProperties("MinorTicks", this);
        }
