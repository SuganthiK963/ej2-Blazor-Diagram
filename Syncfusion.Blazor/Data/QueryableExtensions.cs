    ...
    public static class QueryableExtensions
    {
                                                    ...
                                                    Type sourceType)
        {
            ...
            foreach (string property in propertyNameList)
            {
                if (exp != null)
                {
                    if (string.Equals("ExpandoObject", exp.Type.Name, StringComparison.Ordinal) || isExpando)
                    {
        ...
        private static MethodInfo GetQueryableAverageMethod(Type bodyType)
        {
            ...
            if (NullableHelperInternal.IsNullableType(bodyType))
            {
                ...
                {
                    case "Int32":
                        method = queryableAverageMethod[1];
                        break;
                    case "Single":
                        method = queryableAverageMethod[3];
                        break;
                    case "Int64":
                        method = queryableAverageMethod[5];
                        break;
                    case "Double":
                        method = queryableAverageMethod[7];
                        break;
                    case "Decimal":
                        method = queryableAverageMethod[9];
                        break;
                }
            }
            else
            {
                ...
                {
                    case "Int32":
                        method = queryableAverageMethod[0];
                        break;
                    case "Single":
                        method = queryableAverageMethod[2];
                        break;
                    case "Int64":
                        method = queryableAverageMethod[4];
                        break;
                    case "Double":
                        method = queryableAverageMethod[6];
                        break;
                    case "Decimal":
                        method = queryableAverageMethod[8];
                        break;
                }
            }
